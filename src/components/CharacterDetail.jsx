...
function CharacterInfo({ character, addToFavorites, isAddToFavorites }) {
  return (
  ...
  return (
    <div className="character-episodes">
      <div className="title">
        ...
        <button onClick={()=>setSortAsce((is) => !is)}>
          <ArrowUpCircleIcon className="icon" style={{ rotate: sortAsce ? '0deg' : '180deg' }}/>
        </button>
      </div>
      <ul>
